...
int up2(v_var *a)
{
    for (int i = 0; i != a->_coli2->size; i += 1) {
        ...
        && a->_char[a->_statut->sex].pos_char.y - 15 >= a->_coli2[i].pos_coli.y
...
int up3(v_var *a)
{
    for (int i = 0; i != a->_coli3->size; i += 1) {
        ...
        && a->_char[a->_statut->sex].pos_char.y - 15 >= a->_coli3[i].pos_coli.y
...
int up4(v_var *a)
{
    for (int i = 0; i != a->_coli4->size; i += 1) {
        ...
        && a->_char[a->_statut->sex].pos_char.y - 15 >= a->_coli4[i].pos_coli.y
